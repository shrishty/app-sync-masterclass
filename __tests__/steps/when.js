...
const a_user_calls_getProfile = async (user, screenName) => {
  ...
  console.log(`[${user.username}] - fetched profile for [${screenName}]`, profile)
...
const a_user_calls_follow = async (user, userId) => {
  ...
  console.log(`[${user.username}] - followed user [${userId}]`, result)
...
const a_user_calls_unfollow = async (user, userId) => {
  ...
  console.log(`[${user.username}] - unfollowed user [${userId}]`, result)
