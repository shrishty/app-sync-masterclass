...
describe('Given an authenticated user with a tweet', () => {
    ...
    beforeAll(async () => {
        ...
        tweet = await when.we_invoke_tweet(userA.username)
    })
    ...
    describe("when he retweets his own tweet", () => {
        ...
        it('increments the retweets count in the retweets table', async () => {
        ...
        it('dosent save anything to the timelines table', async () => {
